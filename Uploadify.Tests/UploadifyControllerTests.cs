...
using Moq;
using UploadifyAPI.Controllers;

namespace UploadifyAPI.Tests
{
    public class UploadifyControllerTests
    {
        private readonly UploadifyController.FileUploadController _controller;

        public UploadifyControllerTests()
        {
            _controller = new UploadifyController.FileUploadController();
        }
